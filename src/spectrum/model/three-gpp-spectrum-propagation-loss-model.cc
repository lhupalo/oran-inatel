                                                           ...
                                                           const ns3::Vector &sSpeed, const ns3::Vector &uSpeed) const
{
  ...
  uint8_t numCluster = static_cast<uint8_t> (params->m_channel[0][0].size ());
  // std::cout << unsigned(numCluster) << std::endl;
  ...
  for (uint8_t cIndex = 0; cIndex < numCluster; cIndex++)
    {
      ...
      // std:: cout << temp_doppler << "   " << exp (std::complex<double> (0, temp_doppler)) << std::endl;
                                                                    ...
                                                                    Ptr<const MobilityModel> b) const
{
  ...
  // std:: cout << a->GetPosition() << "   " << b->GetPosition() << std:: endl;
  ...
  // std:: cout << aAntenna->GetElementFieldPattern() << std::endl;
  // std:: cout << "a node " << a->GetObject<Node> () << " antenna " << aAntenna->GetBeamformingVector()  << std::endl;
  ...
  // std:: cout << "b node " << bId << " antenna " << bAntenna->GetBeamformingVector() << std::endl;
